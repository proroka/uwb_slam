...
random_init = true;                 % local or global initialization
easy_init = true;                   % initialization of 1 particle on robot
walls = 1;                          % true if using walls for particle weighting
simple_motion = true;               % brownian motion
...
a_lim = [0 3 0 3];               % robot arena: xmin xmax ymin ymax [m]
